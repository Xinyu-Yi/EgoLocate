...
public:
    ...
    float thNearPointsRealScale = 0.1;
    float thMinBaselineRealScale = 0.01;
    bool isInitializingTransPose2 = false;
    bool constrainRelativeEigenRatio = false;
    int numMinFrameInitializeTransPose2 = 40;
    unsigned long last_nkfs = 0;

    float initMSEerr = 0;  // for debug
    float curMSEerr = 0;   // determine whether Sjc correct
