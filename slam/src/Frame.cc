...
Frame::Frame(const Frame &frame)
    :mpcpi(frame.mpcpi),mpORBvocabulary(frame.mpORBvocabulary), mpORBextractorLeft(frame.mpORBextractorLeft), mpORBextractorRight(frame.mpORBextractorRight),
     ...
     local_transpose_pose(frame.local_transpose_pose), local_transpose_pose_not_align(frame.local_transpose_pose_not_align),
     mTcw(frame.mTcw), mbHasPose(false), mbHasVelocity(false), transpose_pose(frame.transpose_pose), use_transpose(frame.use_transpose)
{
