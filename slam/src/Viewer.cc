...
void Viewer::Run()
{
    ...
    pangolin::OpenGlMatrix Twc, Twr, Twcref;
    Twc.SetIdentity();
    ...
    while(1)
    {
        ...
        mpMapDrawer->GetCurrentOpenGLCameraMatrix(Twc, Ow, Twcref);
        ...
        // mpMapDrawer->DrawReferenceCamera(Twcref);  // draw reference pose for debug
